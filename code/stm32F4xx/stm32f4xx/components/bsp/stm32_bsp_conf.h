...
#define STM32_BSP_PLATFORM  STM32F4_FAMILY
...
#elif STM32_BSP_PLATFORM == STM32F2_FAMILY
	#include "stm32f10x_bsp_conf.h"
#elif STM32_BSP_PLATFORM == STM32F3_FAMILY
	#include "stm32f10x_bsp_conf.h"
#elif STM32_BSP_PLATFORM == STM32F4_FAMILY
	#include "stm32f4xx_bsp_conf.h"
#elif STM32_BSP_PLATFORM == STM32L0_FAMILY
	#include "stm32f10x_bsp_conf.h"
#elif STM32_BSP_PLATFORM == STM32L1_FAMILY
	#include "stm32f10x_bsp_conf.h"
#elif STM32_BSP_PLATFORM == STM32L4_FAMILY
